...
import com.javanauta.usuario.infraestructure.config.entity.Endereco;
...
import com.javanauta.usuario.infraestructure.config.repository.EnderecoRepository;
import com.javanauta.usuario.infraestructure.config.repository.TelefoneRepository;
import com.javanauta.usuario.infraestructure.config.repository.UsuarioRepository;
import com.javanauta.usuario.infraestructure.config.security.JwtUtil;
...
public class UsuarioService {
    ...
    public UsuarioDTO buscarUsuarioPorEmail(String email) {
        try {
            ...
            throw new ResourceNotFound("Email não encontrado " + email);
        }
    }
    ...
    public EnderecoDTO atualizaEndereco(Long idEndereco, EnderecoDTO enderecoDTO) {
        ...
        Endereco entity = enderecoRepository.findById(idEndereco).orElseThrow(() ->
                new ResourceNotFound("Id não encontrado " + idEndereco));
    ...
    public TelefoneDTO atualizaTelefone(Long idTelefone, TelefoneDTO dto) {
        ...
        Telefone entity = telefoneRepository.findById(idTelefone).orElseThrow(() ->
                new ResourceNotFound("Id não encontrado " + idTelefone));
    ...
    public EnderecoDTO cadastraEndereco(String token, EnderecoDTO dto) {
        ...
        Usuario usuario = usuarioRepository.findByEmail(email).orElseThrow(() ->
                new ResourceNotFound("Email não localizado" + email));
